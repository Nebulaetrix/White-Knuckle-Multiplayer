...
namespace White_Knuckle_Multiplayer.Networking.Transports.Steam;
...
public class SteamClient : SteamPeer, IClient
{
    ...
    {
        Disconnected?.Invoke(this, new Riptide.Transports.DisconnectedEventArgs(steamConnection, reason));
    }
}